...
<body>
    ...
    <!-- NAVBAR ĐƯỢC ĐẶT Ở ĐÂY - PHÍA TRÊN CONTENT -->
    ...
    <!-- CONTENT WRAPPER - Có padding-top để tránh bị che bởi navbar fixed -->
    <div id="pageWrapper">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Đảm bảo navbar luôn ở vị trí đúng
            function fixNavbarPosition() {
                if (navbar) {
                    ...
                    // Điều chỉnh padding cho pageWrapper
            ...
            // Gọi fix khi load và khi resize
            fixNavbarPosition();
