...
<head>
    ...
    <title>Login | {{ config('app.name', 'SynWavEco') }}</title>
        ...
        <div class="auth-container">
            ...
            <div class="auth-card">
                ...
                <div class="auth-form-section">
                    <!-- Header: Logo + SynWavEco bên trái, Register bên phải -->
                    ...
                    <p class="fs-xs mb-0 mt-4 text-center">
                        Copyright &copy; by <a href="#" target="_blank">{{ config('app.name', 'SynWavEco') }}</a>. Sign In. Privacy policy
                    </p>
                </div>
            </div>
        </div>
