...
<section class="container pt-3 mb-4">
    <div class="row">
        <div class="col-12">
            <h5 class="mb-3 text-muted small text-uppercase fw-bold">Featured Articles</h5>
                ...
                <div class="col-xl-5 col-xxl-4 offset-xxl-1 d-flex align-items-center mt-xl-n3">
                    <div class="swiper px-5 pe-xl-0 ps-xxl-0 me-xl-n5"
                        ...
                        <div class="swiper-wrapper">
                            @foreach($featuredArticles->take(5) as $art)
    ...
    <div class="col-12">
        <h5 class="mb-3 text-muted small text-uppercase fw-bold">Featured Products</h5>
        <div class="overflow-auto" data-simplebar data-simplebar-auto-hide="false" style="margin-bottom: 1px !important;">
            <div class="d-flex flex-nowrap align-items-center" style="min-width: max-content; margin-bottom: 1px !important; ">
                @foreach($manufactures as $value )
                <div style="width: 160px; flex-shrink: 0; margin-bottom: 1px !important;">
                ...
                <div class="swiper px-5 pe-xl-0 ps-xxl-0 me-xl-n5"
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide text-center text-xl-start pt-5 py-xl-5">
                            ...
                            <a class="btn btn-lg btn-primary" href="{{ route('frontend.products.product_category_details', ['categoryname_slug' => $product->category->slug, 'productname_slug' => $product->slug]) }}">
    ...
    <div class="overflow-auto" data-simplebar data-simplebar-auto-hide="false" style="margin-top: 1px !important;">
        <div class="d-flex flex-nowrap align-items-center" style="min-width: max-content; margin-top: 1px !important;">
            @foreach($categories as $value )
            <div style="width: 160px; flex-shrink: 0; margin-top: 1px !important;">
